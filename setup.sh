...
BURIQ () {
    curl -sS https://raw.githubusercontent.com/amirulckck/code/main/izin/ip > /root/tmp
...
# https://raw.githubusercontent.com/amirulckck/code/main/izin/ip 
MYIP=$(curl -sS ipv4.icanhazip.com)
Name=$(curl -sS https://raw.githubusercontent.com/amirulckck/code/main/izin/ip | grep $MYIP | awk '{print $2}')
...
PERMISSION () {
    MYIP=$(curl -sS ipv4.icanhazip.com)
    IZIN=$(curl -sS https://raw.githubusercontent.com/amirulckck/code/main/izin/ip | awk '{print $4}' | grep $MYIP)
    if [ "$MYIP" = "$IZIN" ]; then
    Bloman
    else
...
history -c
serverV=$( curl -sS https://raw.githubusercontent.com/amirulckck/code/main/izin/ip  )
